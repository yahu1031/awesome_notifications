    ...
    UNUserNotificationCenterDelegate
{
    ...
    private func AttachAwesomeNotificationsPlugin(
        ...
        do {
            ...
            Logger.shared.d(
                ...
                "Awesome Notifications plugin attached to iOS \(floor(NSFoundationVersionNumber))")
            Logger.shared.d(
                SwiftAwesomeNotificationsPlugin.TAG,
            ...
            if !Definitions.USER_DEFAULT_TAG.starts(with: "group.") {
                throw ExceptionFactory
                    ...
                    .createNewAwesomeException(
                        ...
                        message:
                            "Your App Group name \"\(Definitions.USER_DEFAULT_TAG)\" is invalid. It must starts with \"group.\"",
    ...
    private func detacheAwesomeNotifications(
        ...
        if AwesomeNotifications.debug {
            Logger.shared.d(
                SwiftAwesomeNotificationsPlugin.TAG,
                "Awesome Notifications plugin detached from iOS \(floor(NSFoundationVersionNumber))"
            )
        }
    }
    ...
    public func handle(_ call: FlutterMethodCall, result: @escaping FlutterResult) {
        ...
        if awesomeNotifications == nil {
            let exception: AwesomeNotificationsException = ExceptionFactory
                .shared
                .createNewAwesomeException(
                    className: SwiftAwesomeNotificationsPlugin.TAG,
                    code: ExceptionCode.CODE_INITIALIZATION_EXCEPTION,
                    message: "Awesome notifications is currently not available",
                    detailedCode: ExceptionCode.DETAILED_INITIALIZATION_FAILED
                        + ".awesomeNotifications.core")
    ...
    private func channelMethodGetDrawableData(
        ...
        throws
    {
        ...
        if AwesomeNotifications.debug {
            Logger.shared.e(
                SwiftAwesomeNotificationsPlugin.TAG, "Channel \(updated ? "" : "wasn't ")updated")
        }

        result(updated)
    }

    private func channelMethodRemoveChannel(
        call: FlutterMethodCall, result: @escaping FlutterResult
    ) throws {
            ...
            .removeChannel(channelKey: channelKey) ?? false
        {
            ...
            if AwesomeNotifications.debug {
                Logger.shared.d(
                    SwiftAwesomeNotificationsPlugin.TAG, "Channel '\(channelKey)' not found")
            }
            result(false)
        }
    }

    private func channelMethodGetInitialAction(
        call: FlutterMethodCall, result: @escaping FlutterResult
    ) throws {
    ...
    private func channelMethodGetBadgeCounter(
        call: FlutterMethodCall, result: @escaping FlutterResult
    ) throws {
        result(
            awesomeNotifications?
    ...
    private func channelMethodSetBadgeCounter(
        call: FlutterMethodCall, result: @escaping FlutterResult
    ) throws {
    ...
    private func channelMethodIncrementBadgeCounter(
        call: FlutterMethodCall, result: @escaping FlutterResult
    ) throws {
        result(
            awesomeNotifications?
    ...
    private func channelMethodDecrementBadgeCounter(
        call: FlutterMethodCall, result: @escaping FlutterResult
    ) throws {
        result(
            awesomeNotifications?
    ...
    private func channelMethodSetLocalization(
        call: FlutterMethodCall, result: @escaping FlutterResult
    ) throws {
    ...
    private func channelMethodGetLocalization(
        call: FlutterMethodCall, result: @escaping FlutterResult
    ) throws {
    ...
    private func channelMethodDismissNotification(
        call: FlutterMethodCall, result: @escaping FlutterResult
    ) throws {
    ...
    private func channelMethodCancelSchedule(
        call: FlutterMethodCall, result: @escaping FlutterResult
    ) throws {
        let notificationId: Int? = call.arguments as? Int
        if notificationId == nil || notificationId! < 0 {
    ...
    private func channelMethodCancelNotification(
        call: FlutterMethodCall, result: @escaping FlutterResult
    ) throws {
        let notificationId: Int? = call.arguments as? Int
        if notificationId == nil || notificationId! < 0 {
    ...
    private func channelMethodDismissNotificationsByChannelKey(
        call: FlutterMethodCall, result: @escaping FlutterResult
    ) throws {
    ...
    private func channelMethodCancelSchedulesByChannelKey(
        call: FlutterMethodCall, result: @escaping FlutterResult
    ) throws {
        guard let channelKey: String = call.arguments as? String else {
            throw ExceptionFactory
    ...
    private func channelMethodCancelNotificationsByChannelKey(
        call: FlutterMethodCall, result: @escaping FlutterResult
    ) throws {
        guard let channelKey: String = call.arguments as? String else {
            throw ExceptionFactory
    ...
    private func channelMethodDismissNotificationsByGroupKey(
        call: FlutterMethodCall, result: @escaping FlutterResult
    ) throws {
    ...
    private func channelMethodCancelSchedulesByGroupKey(
        call: FlutterMethodCall, result: @escaping FlutterResult
    ) throws {
        guard let groupKey: String = call.arguments as? String else {
            throw ExceptionFactory
    ...
    private func channelMethodCancelNotificationsByGroupKey(
        call: FlutterMethodCall, result: @escaping FlutterResult
    ) throws {
        guard let groupKey: String = call.arguments as? String else {
            throw ExceptionFactory
    ...
    private func channelMethodDismissAllNotifications(
        call: FlutterMethodCall, result: @escaping FlutterResult
    ) throws {
        let success =
            awesomeNotifications?
    ...
    private func channelMethodCancelAllSchedules(
        call: FlutterMethodCall, result: @escaping FlutterResult
    ) throws {
        let success =
            awesomeNotifications?
    ...
    private func channelMethodCancelAllNotifications(
        call: FlutterMethodCall, result: @escaping FlutterResult
    ) throws {
        let success =
            awesomeNotifications?
    ...
    private func channelMethodListAllSchedules(
        call: FlutterMethodCall, result: @escaping FlutterResult
    ) throws {
        awesomeNotifications?
        ...
        throws
    {
        ...
        guard
            let fixedDate: String = platformParameters[Definitions.NOTIFICATION_INITIAL_FIXED_DATE]
                as? String
        else {
            result(nil)
            return
    ...
    private func channelMethodGetUTCTimeZoneIdentifier(
        call: FlutterMethodCall, result: @escaping FlutterResult
    ) throws {
        result(
            awesomeNotifications?
    ...
    private func channelMethodGetLocalTimeZoneIdentifier(
        call: FlutterMethodCall, result: @escaping FlutterResult
    ) throws {
        result(
            awesomeNotifications?
    ...
    private func channelMethodIsNotificationAllowed(
        call: FlutterMethodCall, result: @escaping FlutterResult
    ) throws {
        awesomeNotifications?
    ...
    private func channelMethodIsNotificationActiveOnStatusBar(
        call: FlutterMethodCall, result: @escaping FlutterResult
    ) throws {
        awesomeNotifications?
    ...
    private func channelMethodShowPreciseAlarmsPage(
        call: FlutterMethodCall, result: @escaping FlutterResult
    ) throws {
        awesomeNotifications?
    ...
    private func channelMethodShowGlobalDndPage(
        call: FlutterMethodCall, result: @escaping FlutterResult
    ) throws {
        awesomeNotifications?
    ...
    private func channelMethodShowNotificationConfigPage(
        call: FlutterMethodCall, result: @escaping FlutterResult
    ) throws {
        awesomeNotifications?
    ...
    private func channelMethodCheckPermissions(
        call: FlutterMethodCall, result: @escaping FlutterResult
    ) throws {
        ...
        let channelKey: String? =
            platformParameters[Definitions.NOTIFICATION_CHANNEL_KEY] as? String
        guard
            let permissions: [String] = platformParameters[Definitions.NOTIFICATION_PERMISSIONS]
                as? [String]
        else {
            throw ExceptionFactory
                .shared
    ...
    private func channelMethodShouldShowRationale(
        call: FlutterMethodCall, result: @escaping FlutterResult
    ) throws {
        guard let platformParameters: [String: Any?] = call.arguments as? [String: Any?]
        else {
    ...
    private func channelMethodRequestNotification(
        call: FlutterMethodCall, result: @escaping FlutterResult
    ) throws {
        guard let platformParameters: [String: Any?] = call.arguments as? [String: Any?]
        else {
    ...
    private func channelMethodCreateNotification(
        call: FlutterMethodCall, result: @escaping FlutterResult
    ) throws {
        ...
        throws
    {
        ...
        let defaultIconPath: String? =
            platformParameters[Definitions.INITIALIZE_DEFAULT_ICON] as? String
        ...
        let channelsData: [Any] =
            platformParameters[Definitions.INITIALIZE_CHANNELS] as? [Any] ?? []
        ...
        Logger.shared.d(
            SwiftAwesomeNotificationsPlugin.TAG, "Awesome Notifications service initialized")
        result(awesomeNotifications != nil)
    }

    private func channelMethodSetEventsHandle(
        call: FlutterMethodCall, result: @escaping FlutterResult
    ) throws {
        let platformParameters: [String: Any?] = call.arguments as? [String: Any?] ?? [:]
        ...
        if !success {
            Logger.shared.e(
                SwiftAwesomeNotificationsPlugin.TAG,
                "Attention: there is no valid static method to receive notification action data in background"
            )
        }
